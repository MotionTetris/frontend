...
export function performRotateEffect(
...
export function performPushEffect(
  firstRectangle: PIXI.Graphics,
  secondRectangle: PIXI.Graphics,
  alpha: number,
  color: number,
) {
